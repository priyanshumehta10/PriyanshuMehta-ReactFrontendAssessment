  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main
        ...
        style={{ marginLeft: 0 }}
      >
        <div className={`w-full max-w-3xl rounded-2xl shadow-xl p-8 space-y-10 ${cardClasses}`}>
          {/* Header */}
          <section className="text-center">
            ...
            <div className="mb-12 grid gap-8 sm:grid-cols-2">
              <div className={`border rounded-lg p-6 flex flex-col items-center ${theme === "theme2" ? "border-gray-600 bg-gray-700" : ""}`}>
